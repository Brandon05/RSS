...
//        
//        // MARK: - Natasha & iOSDevWeekly
//        //https://swiftnews.curated.co/
//        //https://iosdevweekly.com/
//        let html = getHTML("https://indieiosfocus.curated.co/")
...
//        
//        //MARK: - App Coda
//        let appCodaHTML = getHTML("https://www.appcoda.com/")
//        let sRange = appCodaHTML.range(of: "<section class=\"page-content\">")
//        let sub = appCodaHTML.substring(from: (sRange?.lowerBound)!)
//        //print(sub)
//        let eRange = sub.range(of: "</section")
//        let rangeAppCoda = Range(uncheckedBounds: (lower: appCodaHTML.index((sRange?.lowerBound)!, offsetBy: 0), upper: appCodaHTML.index((eRange?.upperBound)!, offsetBy: 0)))
//        let appCodaHTMLSubstring = sub.substring(to: (eRange?.upperBound)!)
//        print(appCodaHTMLSubstring)
//        //parseAppCoda(appCodaHTMLSubstring)
//        
...
//    }
//    
//    func parseAppCoda(_ html: String) {
//        if let doc = HTML(html: html, encoding: .utf8) {
//            for article in doc.xpath("//h2//a | //h2/following-sibling::p[1]") {
...
//                    dict["title"] = article.text
//                    dict["link"] = article["href"]
//                    articles.append(dict)
//                    
//                } else {
//                    
//                    articles[count]["description"] = article.text
//                    count += 1
//                }
//
//            }
